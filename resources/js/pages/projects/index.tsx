...
export default function ProjectsIndex({ featuredProjects, projects }: Props) {
    ...
    return (
        <>
            <Head title="Projects - PT CTP Tollways">
                <meta name="description" content="Explore PT CTP Tollways' portfolio of toll road infrastructure projects across Indonesia. From major highways to urban toll roads." />
            </Head>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            ...
                            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
                                Connecting Indonesia through world-class toll road infrastructure development
                            </p>
                        </div>
                    </div>
                </section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {featuredProjects.map((project) => (
                                    <Link
                                        ...
                                        className="bg-white rounded-lg shadow-sm hover:shadow-lg transition-shadow border-2 border-blue-200 overflow-hidden group"
                                    >
                                        ...
                                        <div className="p-6">
                                            <div className="flex items-center mb-2">
                                                <span className="text-lg mr-2">{getStatusEmoji(project.status)}</span>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        {projects.data.length > 0 ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">No projects to display</h3>
                                <p className="text-gray-600">Our project portfolio will be available soon.</p>
                            </div>
                        )}
                    </div>
                </section>
